        ...
        <footer className='bg-base-200'>
            ...
            <div className="mx-auto md:w-11/12 p-4 py-6 lg:py-8">
                <div className="flex justify-between">
                    <div className="">
                        <div className='avatar'>
                            ...
                            <span className="self-center text-2xl font-semibold whitespace-nowrap ml-2">Bite</span>
                        </div>
                    </div>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm sm:text-center">© 2023 <a href="#" className="hover:underline">Bite™</a>. All Rights Reserved.
                    </span>
